...
This is a problem for binary search trees (BSTs) because an ordered linked list is a BST and searching it is linear. Thus, a BST has log-time searching _on average_, but a linear-time worst case.
...
Which of the following data structures is a type of _maximally-unbalanced_ binary tree?
