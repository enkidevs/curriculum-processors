...
The ledger, or better said "the transaction-based ledger", is a blockchain's *log of transactions*. As with any other ledger, the transacted object must be **uniquely identifiable**, under one form or another. Bitcoin, like most of the other blockchains, are gravitating around their only asset - the cryptocoin. Hence, the Bitcoin ledger will record bitcoin transactions[1].

Other types of ledgers include an account-based ledger, used by the Ethereum blockchain, or a combination of the two, used by the QTUM [blockchain](enki.com/glossary/oop) and [another glossary reference between](https://enki.com/glossary/general/oop). What about a [random url](google.com)

A new, [missing reference](enki.com/glossary/missing-link) in a new paragraph.
...
[2: A second footnote]
This is an old style footnote in the header
